...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("2PWarriors", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("2PWarriors", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "2PWarriors";
		app.meta["name"] = "2PWarriors";
